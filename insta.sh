...
checkroot
dependencies
read -p $'\e[1;92mUsername account:_lejlaahmetovic\e[0m' user
...
read -p $'\e[1;92mPassword List (Enter to default list):0013KILLER
0016JS6089
001BlackDuck
001India
002SHARKY002
